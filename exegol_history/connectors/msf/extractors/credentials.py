...
from exegol_history.connectors.msf.utils import is_private_data_hash, MSF_DB_CREDENTIAL_QUERY, MetasploitCredentialType

def sync_credentials(kp: PyKeePass, msf_db_name: str, msf_db_port: int, msf_db_username: str, msf_db_password: str):
