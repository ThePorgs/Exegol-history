...
#Set-Variable -Name INTERFACE -Value 'eth0' -Scope Global
#Set-Variable -Name DOMAIN -Value 'DOMAIN.LOCAL' -Scope Global
#Set-Variable -Name DOMAIN_SID -Value 'S-1-5-11-39129514-1145628974-103568174' -Scope Global
...
#Set-Variable -Name ATTACKER_IP -Value '192.168.56.1' -Scope Global